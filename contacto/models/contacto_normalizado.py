...
class ContactoNormalizado(models.Model):
    ...
    provincia = models.ForeignKey(Provincia, blank=True, null=True, on_delete=models.SET_NULL)
    localidad = models.ForeignKey(Localidad, blank=True, null=True, on_delete=models.SET_NULL)
    barrio = models.ForeignKey(Barrio, blank=True, null=True, on_delete=models.SET_NULL)
    calle = models.ForeignKey(Calle ,blank=True, null=True, on_delete=models.SET_NULL)
